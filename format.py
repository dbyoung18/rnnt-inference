...
# change workspace to project root dir
...
def main():
    parser = argparse.ArgumentParser(
        description="Format source files using clang-format, eg: `./format.py csrc -w`.",
    ...
    parser.add_argument(
        "path",
        nargs="*",
        help="file name or path based on root dir.",
        default=["csrc", "datasets", "models", "tests"],
    )
    parser.add_argument(
        "-w",
        "--write",
    ...
    print(">>> format cpp code with clang")
    format_type = [".cpp", ".c", ".h", ".cc", ".hpp", ".inl"]
    ...
    print(">>> format python code with black")
    if args.write:
